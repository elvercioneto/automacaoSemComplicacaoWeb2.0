...
Funcionalidade: Login
  ...
  Esquema do Cenario: Realizar login <identificacao>
    ...
    Exemplos:
      ...
      | com campos obrigatórios | elvercio | Senha123 | false    |
      | todos os campos         | elvercio | Senha123 | true     |
  @loginInvalido
  Esquema do Cenario: Realizar login com <identificacao>
    ...
    Exemplos:
      ...
      | senha inválida   | elvercio  | invalida | false    |
  @dadosEmBranco
  Esquema do Cenario: Realizar login com <identificacao>
    Quando os campos de login forem preenchidos com os valores
      | usuario  | <usuario>  |
    ...
    Exemplos:
      ...
      | senha em branco   | elvercio |       | false    |